...
<form action="/login" method="POST" class="mt-8 space-y-6">
    ...
    <div>
        ...
        <input id="email" name="email" type="email" autocomplete="email" placeholder="Email@gmail.com" autofocus required value="{{ old('email') }}"
    ...
    <p class="text-sm text-gray-500">Belum punya akun ? <a href="/register" class="text-blue-500 font-semibold">Register</a></p>
