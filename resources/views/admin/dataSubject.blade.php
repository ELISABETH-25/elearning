            ...
            <table class="min-w-full divide-y divide-gray-200 text-xs">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Daftar Kelas</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200 text-xs">
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2">
                            ...
                            {{ $subject->kelasDirect->pluck('name')->unique()->join(', ') }}
                            @else
                        ...
                        <td class="px-1 py-2">
                            <div class="flex items-center justify-between gap-3">
                                <a href="{{ route('subject.view', $subject->id) }}" class="cursor-pointer">
