            ...
            <table class="min-w-full divide-y divide-gray-200 text-xs">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">NIP / NUPTK</th>
                        <th class="px-4 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Jabatan</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200 text-xs">
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2">{{ $teacher->category_count }}</td>
                        <td class="px-1 py-2">
                            <div class="flex items-center justify-between gap-3">
                                <a href="{{ route('teacher.view', $teacher->id) }}" class="cursor-pointer">
